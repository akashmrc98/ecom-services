package com.ecom.products.bootstrap;

import com.ecom.products.domain.Image;
import com.ecom.products.domain.Product;
import com.ecom.products.repository.ImageRepository;
...
public class BootstrapData implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		if(productRepository.count() == 0){
			...
			path = path + "/api/products/src/main/resources";
			System.out.println(path);

			Product product1 = new Product();
			List<String> product1Specs = new ArrayList<>();
			product1Specs.add("Ultra-quiet mouse with 90% reduced click sound");
			product1Specs.add("Comfortable mobile shape is small enough to toss");
			product1Specs.add("USB Receiver is provided with the mouse");
...
//		product1.setSpecifications(product1Specs);
			...
			List<String> product2Specs = new ArrayList<>();
			product2Specs.add("JBL Signature Sound");
			product2Specs.add("One-Button Universal Remote with Mic");
			product2Specs.add("Noise Cancelling Microphone");
			product2.setId(2L);
...
//		product2.setSpecifications(product2Specs);
			...
			File product_b3_file = new File(path + "/products/Product2/product_b3.jpg");
			...
			List<String> product3Specs = new ArrayList<>();
			product3Specs.add("64GB");
			product3Specs.add("Free up space on your OTG-enabled Android phone");
			product3Specs.add("Retractable design with dual micro-USB and USB 3.0 connectors");
			product3.setId(4L);
...
//		product3.setSpecifications(product3Specs);
			...
			List<String> product4Specs = new ArrayList<>();
			product4Specs.add("48MP rear camera | 8MP tele + 16MP camera");
			product4Specs.add("4000mAH lithium-ion battery");
			product4Specs.add("8GB RAM | 256GB internal memory");
			product4.setId(4L);
...
//		product4.setSpecifications(product4Specs);
			...
			List<String> product5Specs = new ArrayList<>();
			product5Specs.add("Intel Core i7 9700 Desktop 9th Gen 8 Cores");
			product5Specs.add("8 Cores /8 Threads");
			product5Specs.add("Intel UHD Graphics 630");
			product5.setId(5L);
...
//		product5.setSpecifications(product5Specs);
			...
			List<String> product6Specs = new ArrayList<>();
			product6Specs.add("2.60GHz Intel Core i7-9750H 9th Gen processor");
			product6Specs.add("1TB 7200rpm HDD+ 256 GB SSD | 8GB DDR4 RAM");
			product6Specs.add("15.6-inch screen, NVIDIA GTX 1650 4GB Graphics");
			product6.setId(6L);
